...
public:
    ...
    const EnvironmentModel& getEnvironmentModel() const;
    virtual void setEnvironmentModel(const EnvironmentModel& environmentModel);
    const SystemModel& getSystemModel() const;
    void setSystemModel(const SystemModel& systemModel);
