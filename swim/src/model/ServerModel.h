...
class ServerModel : public pladapt::Configuration {
...
public:
    ServerModel();
    ServerModel(int servers, int bootRemain, int brownoutLevel, bool coldCache);

//    virtual bool operator==(const ServerModell& other) const;
//    virtual void printOn(std::ostream& os) const;
//    virtual unsigned poweredServers() const;
//
//    friend std::ostream& operator<<(std::ostream& os, const ServerModel& config);
