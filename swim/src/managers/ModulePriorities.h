...
/* this is used for analysis if adaptation is needed */
#define ANLYSER_PRIO 3

/* this is used for planning mitigating adapptation plan */
#define PLANNER_PRIO 4

/* this is for the adaptation mgr */
#define ADAPTATION_MGR_PRIO 5

/* this is for emitting signals reflecting actions just taken by adapt mgr */
#define MONITOR_POST_PRIO 6
